  ...
  return (
    ...
    <section>
      ...
      <div class="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 ">
        ...
        <Card
          shadow={false}
          className="relative grid h-full w-full items-start justify-center overflow-hidden group"
        >
          <CardHeader
            floated={false}
            shadow={false}
            color="transparent"
            className="absolute inset-0 m-0 h-full w-full rounded-none bg-[url('http://innovador.solutions/wp-content/uploads/2024/10/Gaming-scaled.jpg')] bg-cover bg-center group-hover:blur-lg  transition-all duration-500 group-hover:scale-150"
          >
            <div className="to-bg-black-10 absolute inset-0 h-full w-full bg-gradient-to-t from-black/80 via-black/50" />
          </CardHeader>
          <CardBody className="relative py-6 md:py-8 px-6 md:px-8">
          <Typography
              variant="h5"
              color="white"
            ...
            <Typography
              variant="p"
              color="white"
              className="mb-6 font-medium leading-[1.5] opacity-0 translate-x-full group-hover:translate-x-0 transition-all duration-500 group-hover:opacity-100"
            >
        ...
        >
          <CardHeader
            ...
            shadow={false}
            color="transparent"
            className="absolute inset-0 m-0 h-full w-full rounded-none bg-[url('http://innovador.solutions/wp-content/uploads/2024/10/Distribution-min-scaled.jpg')] bg-cover bg-center group-hover:blur-lg  transition-all duration-500 group-hover:scale-150"
          >
            <div className="to-bg-black-10 absolute inset-0 h-full w-full bg-gradient-to-t from-black/80 via-black/50" />
          </CardHeader>
          <CardBody className="relative py-6 md:py-8 px-6 md:px-8">
        ...
        >
          <CardHeader
            ...
            shadow={false}
            color="transparent"
            className="absolute inset-0 m-0 h-full w-full rounded-none bg-[url('http://innovador.solutions/wp-content/uploads/2024/10/Education-min-scaled.jpg')] bg-cover bg-center group-hover:blur-lg  transition-all duration-500 group-hover:scale-150"
          >
            <div className="to-bg-black-10 absolute inset-0 h-full w-full bg-gradient-to-t from-black/80 via-black/50" />
          </CardHeader>
          <CardBody className="relative py-6 md:py-8 px-6 md:px-8">
        ...
        >
          <CardHeader
            ...
            shadow={false}
            color="transparent"
            className="absolute inset-0 m-0 h-full w-full rounded-none bg-[url('http://innovador.solutions/wp-content/uploads/2024/10/Healthcare-min-scaled.jpg')] bg-cover bg-center group-hover:blur-lg  transition-all duration-500 group-hover:scale-150"
          >
            <div className="to-bg-black-10 absolute inset-0 h-full w-full bg-gradient-to-t from-black/80 via-black/50" />
          </CardHeader>
          <CardBody className="relative py-6 md:py-8 px-6 md:px-8">
        ...
        >
          <CardHeader
            ...
            shadow={false}
            color="transparent"
            className="absolute inset-0 m-0 h-full w-full rounded-none bg-[url('http://innovador.solutions/wp-content/uploads/2024/10/Finance-min-scaled.jpg')] bg-cover bg-center group-hover:blur-lg  transition-all duration-500 group-hover:scale-150"
          >
            <div className="to-bg-black-10 absolute inset-0 h-full w-full bg-gradient-to-t from-black/80 via-black/50" />
          </CardHeader>
          <CardBody className="relative py-6 md:py-8 px-6 md:px-8">
        ...
        >
          <CardHeader
            ...
            shadow={false}
            color="transparent"
            className="absolute inset-0 m-0 h-full w-full rounded-none bg-[url('http://innovador.solutions/wp-content/uploads/2024/10/Travel-min.png')] bg-cover bg-center group-hover:blur-lg  transition-all duration-500 group-hover:scale-150"
          >
            <div className="to-bg-black-10 absolute inset-0 h-full w-full bg-gradient-to-t from-black/80 via-black/50" />
          </CardHeader>
          <CardBody className="relative py-6 md:py-8 px-6 md:px-8">
